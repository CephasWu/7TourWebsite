...
<body>
	...
	<div class="container bootstrap snippets bootdey">
		<div class="row">
			...
			<%
		  			if(session.getAttribute("statusSuccess")!=null)
		  			{
		  				out.print("<p class='text-danger ml-1'style='position: absolute;left:330px;top:275px;border:3px solid red;width:220px;height:150px;border-radius:10px;font-size:30px'>"+session.getAttribute("statusSuccess")+"</p>");
		  			}
