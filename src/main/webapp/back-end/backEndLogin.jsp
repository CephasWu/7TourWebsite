            ...
            <div class="col-sm-6 col-md-4 col-md-offset-4">
                ...
                <div class="account-wall">
                    ...
                    <form class="form-signin"  METHOD="post" ACTION="<%=request.getContextPath()%>/empServlet">
                        <input type="text" class="form-control" placeholder="請輸入電子信箱" required autofocus name="empEmail">
                        <input type="password" class="form-control" placeholder="請輸入密碼" required name="empPw">
                ...
                <a href="#" class="text-center new-account">建立新員工帳號 </a>
            </div>
        </div>
    </div>
